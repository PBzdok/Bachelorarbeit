...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=\textwidth]{Abbildungen/Ablauf_U2F_Authentifizierung}
...
\clearpage
\subsubsection{View}
Um die Benutzerinteraktion so einheitlich wie möglich zu halten wird die \textit{U2F} Registration ebenfalls in einem Popup Fenster abgewickelt und benötigt deshalb keine eigene gerenderte View.
\chapter{Ergebnisse}
