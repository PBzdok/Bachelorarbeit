...
\end{quote}
Somit deckt der Konnektor viele Bereiche der Softwareentwicklung ab. Da das Projekt so vielseitig ist, gab es mir die Möglichkeit in den verschiedenen Bereichen wie \textit{Java}, \textit{embedded Systems}, \textit{Webschnittstellen}, \textit{Kryptographie} und \textit{GIT} zu arbeiten und mich dort weiterzubilden.\cite{greenwade93}
