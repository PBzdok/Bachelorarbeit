...
Die wohl wichtigste Eigenschaft der vorgestellten Authentifizierungsmethoden ist die Sicherheit. Diese ist je nach Methode unterschiedlich stark und beeinflussbar. Allgemein kann man sagen, dass keine Authentifizierungsmethode hundert-prozentig sicher ist, jedoch ergeben sich je nach Anwendungsfall unterschiedliche Anforderungen an das Sicherheitsniveau der Authentifizierungsmethode. Im folgenden möchte ich eine Sammlung von gängigen Authentifizierungsmethoden darstellen um eine Übersicht im Kontext der Sicherheit zu bieten:
\begin{table}[htbp]
    \begin{tabularx}{\textwidth}{ llXX }
        ...
        Software-basiertes OTP & Besitz & Anwendung auf Endgerät des Benutzers (App, E-Mail Client, Browser), welches Password zur einmaligen Benutzung erzeugt & Kann abgefangen oder gestohlen (Gerät) werden \\
        SMS-basiertes OTP & Besitz & Passwort zur einmaligen Verwendung empfangen per SMS Textnachricht & Kann abgefangen, mitgelesen (Malware) oder gestohlen (Gerät) werden \\
